            ...
            <div class="row h-100">
                <div class="col-lg-5 col-12">
                    <div id="auth-left">
                        ...
                        <h1 class="auth-title">Checked</h1>
                        ...
                        <form method="POST">
                            ...
                            <label for="displayname">วันนี้อยากกินอะไร:</label>
                                <input type="text" class="form-control form-control-lg" id="displayname" name="displayname" value="<?php echo $displayname; ?>" readonly>
                            </div>
                            
                            <button type="submit" class="btn btn-primary btn-block btn-lg shadow-lg mt-5" name="check_in" disabled>เช็คชื่อ</button>
                        </form>
                    </div>
                </div>
                <div class="col-lg-7 d-none d-lg-block col-md-4">
                    <div id="auth-right">
